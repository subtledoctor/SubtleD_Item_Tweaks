...
<div class="section">
  ...
  * Scale armors: like plate mail for AC, like chain for DR and penalties
  ...
  <h4 class="subheader">Component 1065: Tweak the Ring of Air Control (IR-only)</h4>
  <div class="section">
    <p>With Item Revisions, the Ring of Air Control has a 1x/day 'Gaseous Form' ability which I have found to not be very useful. This tweak replaces it with the ability to cast Gust of Wind (knock enemies back + Zone of Free Air), with unlimited uses.</p>
  </div>
  ...
  <h4 class="subheader">Component 1075: Tweak the Martial Staff</h4>
  <div class="section">
    <p>Instead of being a basic Staff +3 (vanilla) or a Staff +2 with increased crit chance (Item Revisions), with this tweak the Martial Staff allows its user to fight more skillfully: it is a Staff +2 with a +1/2 bonus to APR.</p>
  </div>
